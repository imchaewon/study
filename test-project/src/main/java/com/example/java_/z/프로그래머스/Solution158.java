...
public class Solution158 {
	public static void main(String[] args) {
		...
		System.out.println(s.solution(new String[]{"i", "drink", "water"}, new String[]{"want", "to"}, new String[]{"i", "want", "to", "drink", "water"})); // "Yes"
		System.out.println(s.solution(new String[]{"i", "water", "drink"}, new String[]{"want", "to"}, new String[]{"i", "want", "to", "drink", "water"})); // "No"
	}

	public String solution(String[] cards1, String[] cards2, String[] goal) {
		Queue<String> q1 = Arrays.stream(cards1).collect(Collectors.toCollection(LinkedList::new));
		Queue<String> q2 = Arrays.stream(cards2).collect(Collectors.toCollection(LinkedList::new));

		for (String g : goal) {
			boolean equals1 = g.equals(q1.peek());
			boolean equals2 = g.equals(q2.peek());
			if(equals1 || equals2)
				if (equals1)
					q1.poll();
				else
