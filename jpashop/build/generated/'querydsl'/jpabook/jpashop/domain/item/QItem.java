...
public class QItem extends EntityPathBase<Item> {
    ...
    public final ListPath<jpabook.jpashop.domain.OrderItem, jpabook.jpashop.domain.QOrderItem> orderItems = this.<jpabook.jpashop.domain.OrderItem, jpabook.jpashop.domain.QOrderItem>createList("orderItems", jpabook.jpashop.domain.OrderItem.class, jpabook.jpashop.domain.QOrderItem.class, PathInits.DIRECT2);
